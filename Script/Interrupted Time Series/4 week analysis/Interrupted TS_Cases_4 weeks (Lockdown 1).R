...
ggplot(UK, aes(x=date)) +
  ...
  ggtitle("Weekly count of confirmed case numbers in the UK", subtitle = "Plot for 4 weeks before and after lockdown") +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))

# Save Plot
ggsave("INTERRUPTED TIME SERIES PLOT_Cases_4 weeks (Lockdown 1).png",width = 15, limitsize = FALSE, path = Interrupred_Time_Series_Graphs.dir)
